...
public class AStarDiv_915227211 implements AIModule {
  ...
  public static double getHeuristic (PointTile currentPoint, Point endPoint, TerrainMap map) {
        ...
        //euclideanDistance is what it would take it take to fly in a diagonal
        //min cost between all points

        double minCost = 0.8505747126436781;
